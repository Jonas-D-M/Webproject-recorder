...
const server_1 = __importDefault(__nccwpck_require__(921));
...
const node_static_1 = __nccwpck_require__(218);
exports["default"] = (() => {
...
var fs     = __nccwpck_require__(147)
  ...
  , buffer = __nccwpck_require__(300)
  , http   = __nccwpck_require__(685)
  , url    = __nccwpck_require__(310)
  , path   = __nccwpck_require__(17)
  , mime   = __nccwpck_require__(18)
  , util   = __nccwpck_require__(836);
